	...
	if($productCount > 0) {
		while ($row = mysqli_fetch_array($sql)) {
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="10">
				<tr>
					<td>
						<a href="product2.php?id='.$id.'"><img style="border: #666 1px solid;" alt="'.$product_name.'" src="inventory_images/'.$id.'.jpg" width="20%" height="20%" border="1" /></a>
					</td>
				</tr>
				<tr>
					<td>
						...
						<a style="text-decoration: none; color: white;" href="product2.php?id='.$id.'"><b>Mehr Details</b></a>
					</td>
				</tr>
			</table><br>';
		}
