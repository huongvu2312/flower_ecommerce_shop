<?php
	...
	if (strpos($curl_result, "VERIFIED") !== false) {
		...
		mail("vuthuhuonghanoi@gmail.com", "IPN interaction not verified", "$req", "From: vuthuhuonghanoi@gmail.com" );
		//email from business account of PayPal
		exit();
	}
	...
	if ($receiver_email != "vuthuhuonghanoi@gmail.com") {
		$message = "Investigate why and how receiver email is wrong. Email = ".$_POST['receiver_email']."\n\n\n$req";
	    mail("vuthuhuonghanoi@gmail.com", "Receiver Email is incorrect", $message, "From: vuthuhuonghanoi@gmail.com" );
	    exit(); // exit script
	}
	// Check number 2 ------------------------------------------------------------------------------------------------------------
	if ($_POST['payment_status'] != "Completed") {
		...
		mail("vuthuhuonghanoi@gmail.com", "Payment is not completed", $message, "From: vuthuhuonghanoi@gmail.com" );
		exit();
	}
	// Connect to database ------------------------------------------------------------------------------------------------------
	...
	if ($numRows > 0) {
	    ...
	    mail("vuthuhuonghanoi@gmail.com", "Duplicate txn_id in the IPN system", $message, "From: vuthuhuonghanoi@gmail.com" );
	    exit(); // exit script
	} 
	// Check number 4 ------------------------------------------------------------------------------------------------------------
	...
	if ($fullAmount != $grossAmount) {
	        ...
	        mail("vuthuhuonghanoi@gmail.com", "Price Jack or Bad Programming", $message, "From: vuthuhuonghanoi@gmail.com" );
	        exit(); // exit script
	} 
	...
	$sql = mysqli_query($conn, "INSERT INTO transactions (id, payer_email, first_name, last_name, payment_date, mc_gross, payment_currency, txn_id, receiver_email, payment_type, payment_status, txn_type, payer_status, address_street, address_city, address_state, address_zip, address_country, address_status, notify_version, verify_sign, payer_id, mc_currency, mc_fee) 
	...
	mail("vuthuhuonghanoi@gmail.com", "NORMAL IPN RESULT YAY MONEY!", $req, "From: vuthuhuonghanoi@gmail.com");
?>