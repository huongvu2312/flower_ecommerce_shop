...
<body>
	...
	<div id="content">
		...
		<form action="kontakt.php" enctype="multipart/form-data" name="myForm" id="myform" method="post"><table>
			<tr>
				<td>Ihr Name:</td>
				<td><input class="kontakt" type="text" name="kontakt_name" size="64" /></td>
			</tr>
			<tr>
		...
		Bitte beachten Sie hierzu auch unsere <a class="email" href="datenschutz.html"><b>Datenschutzerkl&auml;rung</b></a> und dass Sie der Verwendung dieser hier angegeben Daten jederzeit widersprechen k&ouml;nnen.
	</div><br>
