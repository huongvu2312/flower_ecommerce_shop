        ...
        if(mysqli_num_rows($raw_results) > 0){ // if one or more rows are returned do following
            ...
            // $results = mysql_fetch_array($raw_results) puts data from database into array, while it's valid it does the loop
            	$dynamicResult=''.$dynamicResult.' <table align="center" width="80%" border="0" cellspacing="0" cellpadding="10">
							<tr>
								<td width="20%">
									<a href="product.php?id='.$results['id'].'">
								...
								<td width="80%" align="left">
									...
									<a href="product.php?id='.$results['id'].'" style="color: white;">Mehr Details</a>
								</td>
							</tr>
						</table><br><br>';
            }
...
<body>
	<?php include_once 'template_header.php';?><br><br><br><br><br><br>
